 ...
 if (tracing == true)
{
 ...
 // csma.EnablePcapAll("ns3-lec-project2");
  csma.EnablePcap("ns3-lec-project2", csma1Devices.Get (0),true);     //指定节点 
  csma.EnablePcap("ns3-lec-project2", csma2Devices.Get (0),true);                                                            
                                                                               }
